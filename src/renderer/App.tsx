...
export function App(): ReactElement {
  ...
  const duplicateScanDialogProps = {
    ...
    fingerprintCacheStats: controller.duplicateFingerprintCacheStats,
    fingerprintCacheError: controller.duplicateFingerprintCacheError,
    isFingerprintCacheLoading: controller.isDuplicateFingerprintCacheLoading,
    isFingerprintCacheClearing: controller.isDuplicateFingerprintCacheClearing,
    ...
    onRefreshFingerprintCache: controller.refreshDuplicateFingerprintCacheStats,
    onClearFingerprintCache: controller.clearDuplicateFingerprintCache,
