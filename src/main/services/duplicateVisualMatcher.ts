...
import {
  ...
  IMPROVED_DUPLICATE_SCAN_VISUAL_MATCH_THRESHOLDS,
...
const DEFAULT_MIN_SEQUENTIAL_MATCHES = IMPROVED_DUPLICATE_SCAN_VISUAL_MIN_SEQUENTIAL_MATCHES;
const MIN_USABLE_SAMPLE_COUNT =
  IMPROVED_DUPLICATE_SCAN_VISUAL_MATCH_THRESHOLDS.minUsableSampleCount;
const MIN_CONFIDENCE = IMPROVED_DUPLICATE_SCAN_VISUAL_MATCH_THRESHOLDS.minConfidence;
const MIN_DURATION_RATIO = IMPROVED_DUPLICATE_SCAN_VISUAL_MATCH_THRESHOLDS.minDurationRatio;
const COMMON_HASH_FILE_RATIO = IMPROVED_DUPLICATE_SCAN_VISUAL_MATCH_THRESHOLDS.commonHashFileRatio;
const COMMON_HASH_MIN_FILE_COUNT =
  IMPROVED_DUPLICATE_SCAN_VISUAL_MATCH_THRESHOLDS.commonHashMinFileCount;
