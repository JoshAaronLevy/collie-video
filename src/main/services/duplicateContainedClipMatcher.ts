...
import {
  IMPROVED_DUPLICATE_SCAN_CONTAINED_CLIP_THRESHOLDS,
  IMPROVED_DUPLICATE_SCAN_CONTAINED_MIN_SEQUENTIAL_MATCHES,
  IMPROVED_DUPLICATE_SCAN_DEFAULT_HASH_DISTANCE_THRESHOLD
} from '../../shared/types/duplicateScan';
import { createDuplicatePairKey } from './duplicateVisualMatcher';

const DEFAULT_HASH_DISTANCE_THRESHOLD = IMPROVED_DUPLICATE_SCAN_DEFAULT_HASH_DISTANCE_THRESHOLD;
const DEFAULT_MIN_SEQUENTIAL_MATCHES = IMPROVED_DUPLICATE_SCAN_CONTAINED_MIN_SEQUENTIAL_MATCHES;
const MIN_USABLE_SAMPLE_COUNT =
  IMPROVED_DUPLICATE_SCAN_CONTAINED_CLIP_THRESHOLDS.minUsableSampleCount;
const MIN_DURATION_RATIO_FOR_CONTAINED_CLIP =
  IMPROVED_DUPLICATE_SCAN_CONTAINED_CLIP_THRESHOLDS.minDurationRatio;
const MIN_CONFIDENCE = IMPROVED_DUPLICATE_SCAN_CONTAINED_CLIP_THRESHOLDS.minConfidence;
const COMMON_HASH_FILE_RATIO =
  IMPROVED_DUPLICATE_SCAN_CONTAINED_CLIP_THRESHOLDS.commonHashFileRatio;
const COMMON_HASH_MIN_FILE_COUNT =
  IMPROVED_DUPLICATE_SCAN_CONTAINED_CLIP_THRESHOLDS.commonHashMinFileCount;
